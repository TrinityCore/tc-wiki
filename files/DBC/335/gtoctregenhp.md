...
# GtOCTRegenHP.dbc
##### :open_book: Content on [WoW.tools](https://wow.tools/dbc/?dbc=gtoctregenhp&build=3.3.5.12340)
...
> [Entries: 100 x 11](https://wow.tools/dbc/?dbc=gametables&build=3.3.5.12340#page=1&colFilter[0]=exact%3AOCTRegenHP)
{.is-info}
