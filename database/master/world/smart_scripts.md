...
* For [source_type](#source_type) **SMART_SCRIPT_TYPE_CREATURE** / **SMART_SCRIPT_TYPE_GAMEOBJECT**:
  * entryorguid > 0: [creature_template.entry](/database/master/world/creature_template#entry) / [gameobject_template.entry](/database/master/world/gameobject_template#entry).
  * entryorguid < 0: [creature.guid](/database/master/world/creature#guid) / [gameobject.guid](/database/master/world/gameobject#guid).
&nbsp;
...
SMART_EVENT_KILL | 5 | CooldownMin | CooldownMax | Player only (0/1) | [creature_template.entry](/database/master/world/creature_template#entry)<br/>*(If Param3 is 0)* | | | On creature kill |
...
| SMART_EVENT_SUMMONED_UNIT | 17 | [creature_template.entry](/database/master/world/creature_template#entry) (0 any) | CooldownMin | CooldownMax | | | | On summoned unit |
...
| SMART_EVENT_MOVEMENTINFORM | 34 | [MovementType](https://github.com/TrinityCore/TrinityCore/blob/master/src/server/game/Movement/MovementDefines.h#L28):<ul><li>0 &rarr; Any</li><li>1 &rarr; Random</li><li>2 &rarr; Waypoint ([waypoint_path_node.NodeId](/database/master/world/waypoint_path_node#nodeid))</li><li>8 &rarr; Point</li><li>16 &rarr; Effect (Jump)</li></ul> | PointID (0xFFFFFFFF any) | | | | | On movement inform |
| SMART_EVENT_SUMMON_DESPAWNED | 35 | [creature_template.entry](/database/master/world/creature_template#entry) | CooldownMin | CooldownMax | | | | On summoned unit despawned |
...
| SMART_EVENT_WAYPOINT_REACHED | 40 | [waypoint_path_node.NodeId](/database/master/world/waypoint_path_node#nodeid) (0xFFFFFFFF any) | [waypoint_path_node.PathId](/database/master/world/waypoint_path_node#pathid) (0 any) | | | | | On creature waypoint ID reached |
...
| SMART_EVENT_TEXT_OVER | 52 | [creature_text.GroupID](/database/master/world/creature_text#groupid) | [creature_text.CreatureID](/database/master/world/creature_text#creatureid) (0 any) | | | | | On text over event triggered after SMART_ACTION_TALK |
...
| SMART_EVENT_WAYPOINT_PAUSED | 55 | [waypoint_path_node.NodeId](/database/master/world/waypoint_path_node#nodeid) (0xFFFFFFFF any) | [waypoint_path_node.PathId](/database/master/world/waypoint_path_node#pathid) (0 any) | | | | | On creature waypoint ID paused |
| SMART_EVENT_WAYPOINT_RESUMED | 56 | [waypoint_path_node.NodeId](/database/master/world/waypoint_path_node#nodeid) (0xFFFFFFFF any) | [waypoint_path_node.PathId](/database/master/world/waypoint_path_node#pathid) (0 any) | | | | | On creature waypoint ID resumed |
| SMART_EVENT_WAYPOINT_STOPPED | 57 | [waypoint_path_node.NodeId](/database/master/world/waypoint_path_node#nodeid) (0xFFFFFFFF any) | [waypoint_path_node.PathId](/database/master/world/waypoint_path_node#pathid) (0 any) | | | | | On creature waypoint ID stopped |
| SMART_EVENT_WAYPOINT_ENDED | 58 | [waypoint_path_node.NodeId](/database/master/world/waypoint_path_node#nodeid) (0xFFFFFFFF any) | [waypoint_path_node.PathId](/database/master/world/waypoint_path_node#pathid) (0 any) | | | | | On creature waypoint ID ended |
...
| SMART_EVENT_GOSSIP_SELECT | 62 | [gossip_menu_option.MenuID](/database/master/world/gossip_menu_option#menuid) | [gossip_menu_option.OptionID](/database/master/world/gossip_menu_option#optionid) | | | | | On gossip option selected |
...
| SMART_EVENT_GAME_EVENT_START | 68 | [game_event.eventEntry](/database/master/world/game_event#evententry) | | | | | | On game_event started |
| SMART_EVENT_GAME_EVENT_END | 69 | [game_event.eventEntry](/database/master/world/game_event#evententry) | | | | | | On game_event ended |
...
| SMART_EVENT_DISTANCE_CREATURE | 75 | [creature.guid](/database/master/world/creature#guid) | [creature_template.entry](/database/master/world/creature_template#entry) | Distance | Repeat interval (ms) | | | On creature guid/entry is within distance |
| SMART_EVENT_DISTANCE_GAMEOBJECT | 76 | [gameobject.guid](/database/master/world/gameobject#guid) | [gameobject_template.entry](/database/master/world/gameobject_template#entry) | Distance | Repeat interval (ms) | | | On gameobject guid/entry is within distance |
...
| SMART_ACTION_TALK | 1 | [creature_text.GroupID](/database/master/world/creature_text#groupid) |  |  |  |  |  |  |  |
...
| SMART_ACTION_SUMMON_CREATURE | 12 | [creature_template.entry](/database/master/world/creature_template#entry) | Summon Type | duration in ms | attackInvoker | SmartActionSummonCreatureFlags:<ul><li>1 &rarr; PersonalSpawn</li><li>2 &rarr; PreferUnit</li></ul> |  |  | Summon Unit |
...
| SMART_ACTION_CALL_KILLEDMONSTER | 33 | [creature_template.entry](/database/master/world/creature_template#entry) |  |  |  |  |  |  |  |
...
| SMART_ACTION_UPDATE_TEMPLATE | 36 | [creature_template.entry](/database/master/world/creature_template#entry) | Update Level |  |  |  |  |  |  |
| SMART_ACTION_DIE | 37 |  |  |  |  |  |  |  |  |
...
| SMART_ACTION_SUMMON_GO | 50 | [gameobject_template.entry](/database/master/world/gameobject_template#entry) |  |  |  |  |  |  |  |
...
| SMART_ACTION_EQUIP | 71 | [creature_equip_template.creatureId](//database/master/world/creature_equip_template#CreatureID) | slotmask | Slot1 | Slot2 | Slot3 |  |  |  |
...
| SMART_ACTION_SET_NPC_FLAG | 81 | [creature_template.npcflag](/database/master/world/creature_template#npcflag) |  |  |  |  |  |  |  |
| SMART_ACTION_ADD_NPC_FLAG | 82 | [creature_template.npcflag](/database/master/world/creature_template#npcflag) |  |  |  |  |  |  |  |
| SMART_ACTION_REMOVE_NPC_FLAG | 83 | [creature_template.npcflag](/database/master/world/creature_template#npcflag) |  |  |  |  |  |  |  |
| SMART_ACTION_SIMPLE_TALK | 84 | [creature_text.GroupID](/database/master/world/creature_text#groupid) |  |  |  |  |  |  |  |
...
| :warning: SMART_ACTION_SET_GO_FLAG | 104 | [gameobject_template_addon.flags](//database/master/world/gameobject_template_addon#flags) |  |  |  |  |  |  |  |
| :warning: SMART_ACTION_ADD_GO_FLAG | 105 | [gameobject_template_addon.flags](//database/master/world/gameobject_template_addon#flags) |  |  |  |  |  |  |  |
| :warning: SMART_ACTION_REMOVE_GO_FLAG | 106 | [gameobject_template_addon.flags](//database/master/world/gameobject_template_addon#flags) |  |  |  |  |  |  |  |
| SMART_ACTION_SUMMON_CREATURE_GROUP | 107 | [creature_summon_groups.groupId](//database/master/world/creature_summon_groups#groupId) | Attack Invoker (0/1) |  |  |  |  |  |  |
...
| SMART_ACTION_SCENE_PLAY | 129 | [scene_template.id](/database/master/world/scene_template#id) |  |  |  |  |  |  |  |
| SMART_ACTION_SCENE_CANCEL | 130 | [scene_template.id](/database/master/world/scene_template#id) |  |  |  |  |  |  |  |
| SMART_ACTION_SPAWN_SPAWNGROUP | 131 | [spawn_group.groupId](//database/master/world/spawn_group#groupId) | minDelay | maxDelay | spawnflags |  |  |  |  |
| SMART_ACTION_DESPAWN_SPAWNGROUP | 132 | [spawn_group.groupId](//database/master/world/spawn_group#groupId) | minDelay | maxDelay | spawnflags |  |  |  |  |
...
| SMART_ACTION_CREATE_CONVERSATION | 143 | [conversation_template.id](//database/master/world/conversation_template#Id) |  |  |  |  |  |  |  |
...
| SMART_TARGET_CLOSEST_CREATURE | 19 | [creature_template.entry](/database/master/world/creature_template#entry) (0: any) | Max dist (0-100 yards) | Is dead (0/1) |  | StringId |  |  |  |  | Closest creature with specified entry within specified distance |
| SMART_TARGET_CLOSEST_GAMEOBJECT | 20 | [gameobject_template.entry](/database/master/world/gameobject_template#entry) (0: any) | Max dist (0-100 yards) |  |  | StringId |  |  |  |  | Closest gameobject with specified entry within specified distance |
