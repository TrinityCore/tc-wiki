...
Any record in this table works for any creature under the same entry in creature_template. These can be overriden by the [vehicle_accessory](/database/master/world/vehicle_accessory), which works for specific creatures' guids.
&nbsp;
