...
> This table holds datas about BattleGrounds deserters. To enable storing this kind of informations, set `Battleground.TrackDeserters.Enable = 1` in [worldserver.config](/en/files/configuration/home) file.
{.is-info}
