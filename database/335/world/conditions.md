...
| --- | :---: | --- | --- | --- | --- |
| CONDITION_NONE | 0 | (Never used) | (Never used) | (Never used) | always true |
| CONDITION_AURA | 1 | [Spell ID](/files/DBC/335/spell#id) | Effect index (0 &ndash; 2) | use target? | true if player (or target, if value3) has aura of spell with effect effindex |
| CONDITION_ITEM | 2 | [item entry](/database/335/world/item_template#entry) | item count | 0 = not in bank<br/>1 = in bank | true if has count of item (if 'bank' is set it searches in bank slots too) |
...
| CONDITION_SKILL | 7 | Required [SkillLine ID](/files/DBC/335/skillline#id) | Skill rank value (1 &ndash; 450) | Always 0 |  |
...
| CONDITION_SPAWNMASK | 19 | [creature spawnMask](/database/335/world/creature#spawnmask) or<br/>[gameobject spawnMask](/database/335/world/gameobject#spawnmask) | Always 0 | Always 0 |  |
...
| CONDITION_CREATURE_TYPE | 24 | [creature type](/database/335/world/creature_template#type) | Always 0 | Always 0 | true if creature_template.type = value1 |
| CONDITION_SPELL | 25 | [Spell ID](/files/DBC/335/spell#id) | Always 0 | Always 0 | true if player has learned spell |
| CONDITION_PHASEMASK | 26 | phasemask value | Always 0 | Always 0 |  |
| CONDITION_LEVEL | 27 | Player level (1 &ndash; 80) | [ComparisonType](#comparisontype) | Always 0 |  |
...
| CONDITION_DISTANCE_TO | 35 | Target to which distance is checked<br/>- one of ConditionTargets available in current SourceType | Distance.<br/>Defines distance between current ConditionTarget and target specified in ConditionValue1 | [ComparisonType](#comparisontype) |  |
...
| CONDITION_HP_VAL | 37 | HP value | [ComparisonType](#comparisontype) | Always 0 |  |
| CONDITION_HP_PCT | 38 | Percentage of max HP | [ComparisonType](#comparisontype) | Always 0 |  |
...
| CONDITION_PET_TYPE | 45 | 0 = SUMMON_PET<br/> 1 = HUNTER_PET | Always 0 | Always 0 |  |
...
| CONDITION_QUEST_OBJECTIVE_PROGRESS | 48 | [quest ID](/database/335/world/quest_template#id) | Objective index (0 &ndash; 3) | Counter |  |
...
| :x: CONDITION_OBJECT_ENTRY_GUID_MASTER | 51 | TypeID | entry | guid | true if object is type TypeID<br/>and the entry is 0<br/>or matches entry of the object<br/>or matches guid of the object |
| :x: CONDITION_TYPE_MASK_MASTER | 52 | TypeMask | Always 0 | Always 0 | true if object is type object's<br/>TypeMask matches provided TypeMask using master branch TypeMask |
