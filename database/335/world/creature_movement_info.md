...
Supplemental data to CreatureMovementInfo.dbc (see [#25964](https://github.com/TrinityCore/TrinityCore/discussions/25964))
...
### MovementID
references [creature_template.movementId](../world/creature_template#movementid) and CreatureMovementInfo.dbc/id
&nbsp;
