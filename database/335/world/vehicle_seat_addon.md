...
This table allows to specify special vehicle seat behavior by extending/overriding VehicleSeat.dbc

## Structure

| Field | Type | Attributes | Key | Null | Default | Extra | Comment |
| --- | --- | --- | :---: | :---: | --- | --- | --- |
| [SeatEntry](#seatentry) | int | unsigned | PRI | NO |  |  | VehicleSeat.dbc identifier |
